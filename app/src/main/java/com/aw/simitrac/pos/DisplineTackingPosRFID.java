...
public class DisplineTackingPosRFID extends Activity {
            ...
            public void onSuccess(String result) {
                ...
                if(response.getSuccess()){
                   // Toast.makeText(PermissionRFIDSomanet.this, response.getMessage(), Toast.LENGTH_SHORT).show();
                    ...
                    startActivity(new Intent(getApplicationContext(),DisplineTrackingPos.class));
                    goToServer = true;
                  //  finish();

                }else {
                    Toast.makeText(DisplineTackingPosRFID.this, response.getMessage(), Toast.LENGTH_SHORT).show();
