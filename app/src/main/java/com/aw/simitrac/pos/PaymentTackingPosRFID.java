...
public class PaymentTackingPosRFID extends Activity {
            ...
            public void onSuccess(String result) {
                ...
                if(response.getSuccess()){
                   // Toast.makeText(PermissionRFIDSomanet.this, response.getMessage(), Toast.LENGTH_SHORT).show();
                    ...
                    startActivity(new Intent(getApplicationContext(),PaymentTrackingPos.class));
                    goToServer = true;
                  //  finish();

                }else {
                    Toast.makeText(PaymentTackingPosRFID.this, response.getMessage(), Toast.LENGTH_SHORT).show();
