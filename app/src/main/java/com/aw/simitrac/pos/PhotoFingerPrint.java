...
public class PhotoFingerPrint extends AppCompatActivity {
    //UI
    ImageView photo;
    Camera camera;
    Button button;
    ...
    public void addFingerPrint(){
        AsyncTask.execute(new Runnable() {
            @Override
            public void run() {
                HashMap<String, String> chinga = new HashMap<String, String>();
                chinga.put("function", "addFingerPrint");
                chinga.put("finger_print", sFingerPrint);
                chinga.put("userCode", intent.getStringExtra("userCode"));
                API.POST(getApplicationContext(), chinga, new API.VolleyCallback() {
                    @Override
            ...
            public void run() {
                ...
                API.POST(getApplicationContext(), url_maps, new API.VolleyCallback() {
                    ...
                    public void onSuccess(String result) {
                        ...
                        finish();
                        Toast.makeText(PhotoFingerPrint.this, "success", Toast.LENGTH_SHORT).show();
    ...
    public void initializeUI() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(sPhoto.matches("") ){
                    Toast.makeText(PhotoFingerPrint.this, "Take Photo", Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.photo_finger_reader);
    ...
    protected void launchGetReader() {
        Intent i = new Intent(PhotoFingerPrint.this, GetReaderActivity.class);
    ...
    private void initializeActivity() {
        ...
        fingerPrint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                startActivity(new Intent(getApplicationContext(), PhotoFingerPrint.class));
            }
        });
    ...
    private void displayReaderNotFound() {
        if (!isFinishing()) {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(PhotoFingerPrint.this);
